package br.com.fitogether.api.domain.dto.request.unit

import jakarta.validation.constraints.Max
import jakarta.validation.constraints.Min
import jakarta.validation.constraints.NotNull

data class GetUnitsRequest(
    ...
    @field:Min(value = 5000, message = "Radius must be >= 5000 meters")
    @field:Max(value = 30000, message = "Radius must be <= 30000 meters")
